...
import { deNavbar, enNavbar } from "./navbar/index.js";
import { deSidebar, enSidebar } from "./sidebar/index.js";
...
export default hopeTheme({
  hostname: "https://duckaccounting.com",

  author: {
    name: "Leo",
    url: "https://duckaccounting.com",
  },
  ...
  locales: {
    ...
    '/de/': {
      ...
      blog: {
        description: "Eine Buchhaltungsanwendung",
        intro: "/impressum.html",
      },
